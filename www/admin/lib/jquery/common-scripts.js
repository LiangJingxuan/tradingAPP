...
//    sidebar dropdown menu
    jQuery('#sidebar').delegate('.sub-menu > a','click',function () {
    ...
    // sidebar dropdown menu three
    /*jQuery('#sidebar').delegate('.sub-menu-two > a','click',function () {
        var last = jQuery('.sub-menu-two.open', $('#sidebar'));
        last.removeClass("open");
        jQuery('.arrow', last).removeClass("open");
        jQuery('.sub-two', last).slideUp(200);
        var subTwo = jQuery(this).next();
        if (subTwo.is(":visible")) {
            jQuery('.arrow', jQuery(this)).removeClass("open");
            jQuery(this).parent().removeClass("open");
            subTwo.slideUp(200);
        } else {
